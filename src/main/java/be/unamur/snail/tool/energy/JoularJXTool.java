...
public class JoularJXTool implements EnergyMeasurementTool {
    ...
    public List<Stage> createPostProcessingStages() {
        ...
        return List.of(
                // TODO: create a new module that contains the following stages, so that this new module is responsible for putting all the JoularJX measurements in the database, and this module is only responsible for handling the csv files generated by JoularJX
